...
> **Важно для Figma:** Файл должен быть общедоступным (ссылка с доступом "Может просматривать" или выше). Если бот не может открыть файл — отправь скриншот интерфейса вместо ссылки.
...
| Ссылку на GitHub-репо + диапазон дат (`github.com/owner/repo` + `01-01-2025` — `31-01-2025`) | Релиз-ноты + Changelog |
